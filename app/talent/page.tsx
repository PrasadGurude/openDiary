...
export default function TalentPage() {
  ...
  const filteredContributors = allContributors
    .filter((contributor) => {
      ...
      const matchesSkill = selectedSkill === "all" || contributor.topLanguages.includes(selectedSkill)
      const matchesExperience = experienceLevel === "all" || contributor.experience === experienceLevel

      // New metric filters
      const matchesContributionScore = contributor.contributionScore >= Number.parseInt(minContributionScore)
      const matchesTotalCommits = contributor.totalCommits >= Number.parseInt(minTotalCommits)
      const matchesTotalPRs = contributor.totalPRs >= Number.parseInt(minTotalPRs)
      const matchesFollowers = contributor.githubFollowers >= Number.parseInt(minFollowers)
      const matchesTotalStars = contributor.totalStars >= Number.parseInt(minTotalStars)

      return (
        matchesSearch &&
        matchesSkill &&
        matchesExperience &&
        matchesContributionScore &&
        matchesTotalCommits &&
        matchesTotalPRs &&
        matchesFollowers &&
        matchesTotalStars
  ...
  const uniqueSkills = Array.from(new Set(allContributors.flatMap((c) => c.topLanguages)))
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Discover Talent</h1>
        <p className="text-gray-600">Find skilled developers based on their open-source contributions</p>
      </div>
        ...
        <div className="border-t pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <div className="space-y-2">
              ...
              <Select value={minContributionScore} onValueChange={setMinContributionScore}>
            ...
            <div className="space-y-2">
              ...
              <Select value={minTotalCommits} onValueChange={setMinTotalCommits}>
                <SelectTrigger className="h-9">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={minTotalPRs} onValueChange={setMinTotalPRs}>
                <SelectTrigger className="h-9">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={minTotalStars} onValueChange={setMinTotalStars}>
                <SelectTrigger className="h-9">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600">{filteredContributors.length} developers found</span>
